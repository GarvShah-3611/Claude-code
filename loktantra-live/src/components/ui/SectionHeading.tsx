 ...
 *
 * The label is set in sentence case behind a short violet rule — a
...
export function SectionHeading({
  ...
  return (
    ...
    >
      <p
        className={`reveal mb-5 flex items-center gap-3 text-sm text-violet-light ${
      ...
      <h2 className="reveal text-title text-newsprint md:text-display">
        {children}
      </h2>
      {blurb && (
        <p
